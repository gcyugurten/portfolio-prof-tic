...
<div class="container">
    <div class="text-center py-4 special-heading">Nouvel article</div>
    <div class="path">
        <a href="{{ route('admin.blog.index') }}">Blog</a> > <a href="">Nouvel article</a>
    </div>

    
    <form action="{{ route('admin.blog.store') }}" method="POST" class="py-5" enctype="multipart/form-data">

        @csrf
        <div class="form-group">
            <label for="title">Titre de l'article</label>
            <input type="text" id="title" value="{{ old('title') }}" name="title" placeholder="Titre de l'article" class="form-control">
        </div>
        <div class="form-group">
